...
<div class="container">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="#" style="background-color: rgb(95, 39, 227)">Store Locations and Hours</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#" style="color: rgb(95, 39, 227)">Donations</a>
  </li>
...
<div class="row">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Our Locations and Hours</h5>
        <p class="card-text">Monday-Saturday 11:00 am - 7:00 pm
        </p>
        <p class="card-text">Sunday 12:00 - 6:00 pm </p>
        <p class="card-text">We accept donations M, W, F + Sat </p>
        <p class="card-text"> 1334 Main St.</p>
  ...
  <li class="nav-item">
    <a class="nav-link active" href="#" style="background-color: rgb(95, 39, 227)">Donations</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#" style="color: rgb(95, 39, 227)">Contact Us</a>
  </li>
...
<div class="row">
  <div class="col-sm-6">
    ...
    <p class="card-text">Beads - All types of beads, clasps, ear wires, metal jewelry findings, jewelry cord and wire, gems, raw stones, jewelry making tools and supplies, costume jewelry  </p>
